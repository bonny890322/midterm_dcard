...
# ne names
ne_name = ['EVENT', 'FAC', 'GPE', 'LANGUAGE', 'LAW', 'LOC',
...
# category names
# news_categories = ['政治', '科技', '運動', '證卷', '產經',
#                    '娛樂', '生活', '國際', '社會', '文化', '兩岸', '全部']
news_categories = ['電影','國立高雄科技大學','追星','全部']
...
def load_data_topNer():
    # read data
    df_data = pd.read_csv(
        'app_top_ner/dataset/ALL_topkey_by_ner_and_category.csv')
